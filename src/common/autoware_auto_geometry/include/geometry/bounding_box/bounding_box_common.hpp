...
autoware_auto_msgs::msg::Shape GEOMETRY_PUBLIC get_shape(const BoundingBox & box);
...
geometry_msgs::msg::Pose GEOMETRY_PUBLIC get_pose(const BoundingBox & box);

/// \brief Fill DetectedObject type with contents from a BoundingBox type
/// \param box BoundingBox to be converted
/// \return Filled DetectedObject type
autoware_auto_msgs::msg::DetectedObject GEOMETRY_PUBLIC get_detected_object(
