...
private:
  perception::filters::voxel_grid::Config get_map_config()
  {
    ...
    return perception::filters::voxel_grid::Config{
      get_point_param("localizer.map.min_point"),
      get_point_param("localizer.map.max_point"),
      get_point_param("localizer.map.voxel_size"),
  ...
  {
    EigTranslation pose_translation{
      pose.pose.pose.position.x,
      pose.pose.pose.position.y,
      pose.pose.pose.position.z};
    EigTranslation guess_translation{
      guess.transform.translation.x,
  ...
  virtual bool rotation_valid(
    ...
    const geometry_msgs::msg::TransformStamped guess)
  {
    EigRotation pose_rotation{
      pose.pose.pose.orientation.w,
      pose.pose.pose.orientation.x,
      pose.pose.pose.orientation.y,
      pose.pose.pose.orientation.z
    };
    EigRotation guess_rotation{
