...
class LOCALIZATION_COMMON_PUBLIC LocalizerBase : public common::helper_functions::crtp<Derived>
{
public:
  template<typename InputMsgT, typename MapT, typename RegistrationSummaryT = std::nullptr_t>
  ...
  {
    return this->impl().register_measurement(msg, map, transform_initial, summary);
  }
};
...
// template<typename MapMsgT, typename RegistrationSummaryT>
...
//   {
//     throw std::runtime_error("RelativeLocalizerBase: map insertion is not implemented.");
//   }
