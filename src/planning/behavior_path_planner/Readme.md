...
| `~/input/route`                         | autoware_auto_planning_msgs::msg::HADMapRoute           | Current route from start to goal       |
| `~/input/perception`                    | autoware_auto_perception_msgs::msg::PredictedObjects    | Dynamic objects from perception module |
| `~/input/velocity`                      | autoware_auto_vehicle_msgs::msg::VehicleKinematicState  | For ego-velocity                       |
| `~/input/lateral_offset`                | autoware_auto_planning_msgs::msg::LateralOffset         | Lateral offset on the path             |
| `~/input/external_approval`             | autoware_auto_planning_msgs::msg::Approval              | For remote control                     |
| `~/input/force_approval`                | autoware_auto_planning_msgs::msg::PathChangeModule      | For remote control                     |
...
| `~/output/turn_signal_cmd`                | autoware_auto_vehicle_msgs::msg::TurnIndicatorsCommand  | Turn signal command                                                                             |
| `~/output/hazard_light_cmd`               | autoware_auto_vehicle_msgs::msg::HazardLightsCommand    | Hazard light command                                                                            |
| `~/output/force_available`                | autoware_auto_planning_msgs::msg::PathChangeModuleArray | (For remote control) modules that are force-executable                                          |
| `~/output/ready`                          | autoware_auto_planning_msgs::msg::PathChangeModule      | (For remote control) modules that are ready to be executed                                      |
| `~/output/running`                        | autoware_auto_planning_msgs::msg::PathChangeModuleArray | (For remote control) Current running module                                                     |
| `~/debug/drivable_area`                   | nav_msgs::msg::OccupancyGrid                            | (For debugging) Drivable area to visualize                                                      |
| `~/debug/path_for_visualize`              | nav_msgs::msg::Path                                     | (For debugging) Generated path to visualize                                                     |
| `~/debug/markers`                         | visualization_msgs::msg::MarkerArray                    | (For debugging) Marker array                                                                    |
