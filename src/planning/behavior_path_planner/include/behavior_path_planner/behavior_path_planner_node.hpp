...
private:
  ...
  rclcpp::Subscription<VehicleKinematicState>::SharedPtr velocity_subscriber_;
  rclcpp::Subscription<PredictedObjectsOrgMsg>::SharedPtr perception_subscriber_;
  ...
  // callback
  void onVelocity(const VehicleKinematicState::ConstSharedPtr msg);
  void onPerception(const PredictedObjectsOrgMsg::ConstSharedPtr msg);
...
private:
  ...
  rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr debug_path_publisher_;
