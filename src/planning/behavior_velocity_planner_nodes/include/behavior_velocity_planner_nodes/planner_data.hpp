...
struct PlannerData
{
  ...
  : vehicle_constants_(common::vehicle_constants_manager::declare_and_get_vehicle_constants(node)),
    current_velocity{std::make_shared<geometry_msgs::msg::TwistStamped>()},
    dynamic_objects{std::make_shared<autoware_auto_perception_msgs::msg::PredictedObjects>()},
    no_ground_pointcloud{std::make_shared<sensor_msgs::msg::PointCloud2>()}
  {
  ...
  autoware_auto_perception_msgs::msg::PredictedObjects::ConstSharedPtr dynamic_objects;
