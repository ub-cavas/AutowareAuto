...
{
  const Eigen::Matrix<float64_t, 6, 2> Bezier::getControlPoints() const {
    return m_control_points;
  }

  Bezier::Bezier(const Eigen::Matrix<float64_t, 6, 2> & control_points): m_control_points(control_points)
  {
  }
