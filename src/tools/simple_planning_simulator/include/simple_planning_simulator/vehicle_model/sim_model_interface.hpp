...
protected:
  ...
  //!< @brief gear command defined in autoware_auto_vehicle_msgs/VehicleStateCommand
...
public:
  ...
  /**
   * @brief set gear
   * @param [in] gear gear command defined in autoware_auto_vehicle_msgs/VehicleStateCommand
   */
