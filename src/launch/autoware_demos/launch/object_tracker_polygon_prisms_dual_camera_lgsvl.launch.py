...
def generate_launch_description():
    ...
    multi_object_tracker_using_lgsvl = Node(
        ...
        remappings=[
            ...
            ("polygon_prisms", "/lidars/lidar_polygon_prisms"),
            ("cloud_clusters", "/lidars/cluster_points")
        ],
    ...
    multi_object_tracker_using_ndt = Node(
        ...
        package='tracking_nodes',
        parameters=[
            get_param_file('autoware_demos', 'multi_object_tracker_polygon_prisms.param.yaml'),
            {
                'use_ndt': True,
                'track_frame_id': "map",
            }
