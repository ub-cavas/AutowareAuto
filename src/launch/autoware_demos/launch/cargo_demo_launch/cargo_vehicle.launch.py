...
def generate_launch_description():
    ...
    vlp16_param_file = os.path.join(
        avp_demo_pkg_prefix, 'param/cargo_demo/vlp16.param.yaml')
    ...
    # urdf_pkg_prefix = get_package_share_directory('vehicle_launch')
    # xacro_path = os.path.join(urdf_pkg_prefix, 'urdf/vehicle.xacro')
    # doc = xacro.process_file(xacro_path, mappings={'vehicle_model' : 'ymc_golfcart_proto2'})
    ...
    # print(robot_desc)
    # print(Command(['xacro',' ', xacro_path]))
    # print(urdf_file)
    ...
    vlp16_param = DeclareLaunchArgument(
        'vlp16_param_file',
    ...
    vlp16_driver = Node(
        ...
        namespace='lidars',
        parameters=[LaunchConfiguration('vlp16_param_file')],
